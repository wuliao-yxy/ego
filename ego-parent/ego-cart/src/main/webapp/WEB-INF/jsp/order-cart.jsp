...
<body id="mainframe">
	...
	<form id="orderForm" class="hide"
		action="http://localhost:8086/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName"
			value="smallming" /> <input type="hidden"
			name="orderShipping.receiverMobile" value="15891588888" /> <input
			type="hidden" name="orderShipping.receiverState" value="北京" /> <input
			type="hidden" name="orderShipping.receiverCity" value="北京" /> <input
			type="hidden" name="orderShipping.receiverDistrict" value="昌平区" /> <input
							...
							<div class="sticky-wrap">
								<div class="inner">
									...
									<div style="display: none" id="factoryShipCodShowDivBottom"
										class="dispatching">部分商品货到付款方式：先由易购配送“提货单”并收款，然后厂商发货。</div>
								</div>
