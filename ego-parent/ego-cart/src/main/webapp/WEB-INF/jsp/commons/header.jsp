...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld">
			<a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img
				src="/images/ego-logo.gif" width="270" height="60" alt="易购"></a>
		</div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					...
					<input type="button" value="搜索" class="button"
						onclick="javascript:window.location.href='http://localhost:8083/search.html?q=' + encodeURIComponent(document.getElementById('key').value);return false;"
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld">
					<s></s><a href="http://localhost:8084/user/showLogin"
						clstag="homepage|keycount|home2012|04a">我的易购</a><b></b>
				</dt>
				<dd>
			...
			<dl>
				<dt class="ld">
					<s></s><span class="shopping"><span id="shopping-amount"></span></span><a
						href="http://localhost:8085/cart/cart.html" id="settleup-url">去购物车结算</a> <b></b>
				</dt>
				<!-- 				<dd>
					<div class="prompt">
		...
		<div id="nav-2013">
				...
				<div class="mt ld">
					<h2>
						<a href="http://www.jd.com/allSort.aspx"
							clstag="homepage|keycount|home2013|06a">全部商品分类<b></b></a>
					</h2>
				</div>
			...
			<ul id="navitems-2013">
				...
				<li class="fore4" id="nav-tuan"
					...
					href="http://tuan.jd.com/" target="_blank">团购</a></li>
				...
				<li class="fore6" id="nav-shan"
					...
					href="http://red.jd.com/" target="_blank">闪购</a></li>
				<li class="fore7" id="nav-jinrong"
					clstag="homepage|keycount|home2013|07g1"><a
					href="http://jr.jd.com/" target="_blank">金融</a></li>
			</ul>
		</div>
	</div>
</div>
